...
class lempel_v1:
    ...
    def gen_diccionario(self):
        diccionario = dict()
        code = 0
        for elm in range(256):
            diccionario[chr(elm)] = elm
...
lempel = lempel_v1()
fich = open("libro2.txt","r")
comprimido = lempel.comprimir(fich.read())
descomprimido = lempel.descomprimir(comprimido)
fich = open("descomprimido.txt","w")
fich.write(descomprimido)